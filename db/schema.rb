...
ActiveRecord::Schema.define(version: 20170802015800) do
  ...
  add_index "site_administrators", ["email"], name: "index_site_administrators_on_email", unique: true, using: :btree
  add_index "site_administrators", ["reset_password_token"], name: "index_site_administrators_on_reset_password_token", unique: true, using: :btree
